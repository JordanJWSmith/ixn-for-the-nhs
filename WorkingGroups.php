...
<style id="applicationStylesheet" type="text/css">
	...
	* {
	...
	#Block_Regional_IXN_Administrat {
		position: absolute;
		width: 1711px;
		height: 765px;
		left: 86px;
...
include_once("db_connect.php");
	...
	$admin_result = mysqli_query($link, "SELECT * FROM projects;");
	 ?>
<form method="post" name="submit" action="working_group_function.php">
<div id="Admin_Home">
	<div id="This_is_the_contents_managemen">
		<span>Assign projects to working groups. These projects will be displayed in the relevant working group gallery.</span>
	</div>
	<div id="Block_Projects">
		...
		<table id="customers">
			<tr>
				<th>Title</th>
				<th>Authors</th>
				<th>Systems Interoperability</th>
				<th>Efficiency & Workflows</th>
				<th>AI & Innovation</th>
				<th>MHRA & Standards</th>
				<th>Clinical Safety</th>
				<th>Device Development</th>
				<th>Simulations & Analytics</th>
				<th>Large Scale Infrastructure</th>
				<th>None</th>
			<tr>

					<?php
					// For each regional administrator...
					while($row = mysqli_fetch_array($admin_result)){
						...
						<tr>
							...
							echo "<td><input type='radio' name='ID".$id."' value=".$i." ".$ch."/></td>";
						}
						?>
						<td><input type='radio' name='ID<?php echo $id; ?>' value='NULL'/></td>
							</tr>
							<?php
					}
					 ?>
	...
	<div id="Heading">
		<div id="IXN_for_the_NHS" onclick="window.location='Home.php';">
	...
	<div id="Header">
		...
		<div id="Contents_Management_System" onclick="window.location='admin_home.php';">
